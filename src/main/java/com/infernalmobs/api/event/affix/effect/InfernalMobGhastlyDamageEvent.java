...
/**
 * 恶魂（ghastly）火球造成伤害时的逐受害者事件。
 *
 * <p>直接命中与爆炸范围伤害都会分别广播。取消只会阻止当前受害者的当前伤害，
 * 不会影响其他受害者，也不会回滚已经发生的 ghastly 触发或冷却。
 */
public class InfernalMobGhastlyDamageEvent extends Event implements Cancellable {
    ...
    public InfernalMobGhastlyDamageEvent(LivingEntity mob, LivingEntity victim, Fireball fireball,
